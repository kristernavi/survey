                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                       <a href="{{ route('admin.sub-category.create')}}" role="button" type="button" class="btn btn-success" > ADD</a>
...
<script type="text/javascript">
        ...
        var table = $("#barangay-table").DataTable({
            ...
            "columns": [
            {data: 'parent',  name: 'parent', className: 'col-md-2 text-left',   searchable: true, sortable: true},
               {data: 'name',  name: 'name', className: 'col-md-2 text-left',   searchable: true, sortable: true},
                {data: 'description',  name: 'description', className: 'col-md-5 text-left',   searchable: false, sortable: true},
            ...
            bootbox.confirm({
              ...
              callback: function (result) {
                 if(result){
                  ...
                  $.ajax({
                  url:'/admin/sub-category/'+that.dataset.id,
                  type: 'post',
