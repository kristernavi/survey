                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                       <a href="{{ route('admin.barangay.create')}}" role="button" type="button" class="btn btn-success" > ADD</a>
            ...
            bootbox.confirm({
              ...
              callback: function (result) {
                 if(result){
                  ...
                  $.ajax({
                  url:'/admin/barangay/'+that.dataset.id,
                  type: 'post',
