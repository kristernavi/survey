      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          @if(session('name'))
                ...
                {{ session('name') }} successfully added <a href={{ route('admin.barangay.index')}}>Click here to view </a>
                </div>
          @endif


          {{ Form::open(array('method' => 'POST', 'id' => 'add-barangay-form' , 'route' => 'admin.barangay.store'  , 'class' => 'form-horizontal form-label-left')) }}
