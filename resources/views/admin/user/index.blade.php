                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                       <a href="{{ route('admin.user.create')}}" role="button" type="button" class="btn btn-success" > ADD</a>
        ...
        var table = $("#users-table").DataTable({
            ...
            "columns": [
               {data: 'email',  name: 'email', className: 'col-md-3 text-left',   searchable: true, sortable: true},
                    {data: 'firstname',  name: 'name', className: 'col-md-2 text-left',   searchable: true, sortable: true},
                    {data: 'middlename',  name: 'abn', className: 'col-md-2 text-left',   searchable: true, sortable: true},
                    {data: 'lastname',  name: 'abn_name', className: 'col-md-2 text-left',   searchable: true, sortable: true},

                    {data: 'type',  name: 'type', className: 'col-md-1 text-left',   searchable: true, sortable: true},
                    {data: 'actions',   name: 'actions', className: ' text-center col-md-2',   searchable: false,  sortable: false},
            ],
            ...
            bootbox.confirm({
              ...
              callback: function (result) {
                 if(result){
                  ...
                  $.ajax({
                  url:'/admin/user/'+that.dataset.id,
                  type: 'post',
