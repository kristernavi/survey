      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          @if(session('name'))
                ...
                {{ session('name') }} successfully added <a href={{ route('admin.user.index')}}>Click here to view </a>
                </div>
          @endif


          {{ Form::open(array('method' => 'POST', 'id' => 'add-user-form','enctype' => 'multipart/form-data', 'route' => 'admin.user.store'  , 'class' => 'form-horizontal form-label-left')) }}
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="email" class="form-control" placeholder="Email Addres" name="email" value="{{ old('email')}}">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Type</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              {{ Form::select('type',['surverior' => 'Surverior' , 'admin' => 'Admin'], old('type'),['class' => 'form-control'])}}
            </div>
          </div>
          <div class="form-group">
