      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          @if(session('name'))
                ...
                {{ session('name') }} successfully added <a href={{ route('admin.sub-category.index')}}>Click here to view </a>
                </div>
          @endif


          {{ Form::open(array('method' => 'POST', 'id' => 'add-user-form', 'route' => 'admin.sub-category.store'  , 'class' => 'form-horizontal form-label-left')) }}

            <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Parent Category</label>
            <div class="col-md-4 col-sm-4 col-xs-12">
              {{ Form::select('category_id',$category, old('category_id'),['class' => 'form-control','placeholder' => 'Select Parent Category'])}}
            </div>
          </div>
          <div class="form-group">
